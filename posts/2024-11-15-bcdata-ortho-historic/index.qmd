...
## Estimate Polygon Size based on the Scale and a 8 x 10 Inch Print
...
photos_poly_prep <- layers_trimmed$l_photo_centroids |> 
  ...
  dplyr::mutate(
    ...
    width_m = 10 * scale_parsed * 0.0254,  # Width in meters
    height_m = 8 * scale_parsed * 0.0254, # Height in meters
  ) |>
  # Create geometry
  dplyr::rowwise() |> 
  dplyr::mutate(
