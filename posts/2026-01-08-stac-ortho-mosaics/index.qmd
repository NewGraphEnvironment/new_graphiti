...
Comparing the earliest and most recent imagery side by side shows what has changed over amost a decade.

```{r fig-comparison, fig.cap="Comparison of 2017 and 2025 Sentinel-2 composites.", fig.width=10, fig.height=5}
r_2017 <- rasters[["2017"]]
r_2025 <- rasters[["2025"]]

par(mfrow = c(1, 2))
terra::plotRGB(r_2017, r = 3, g = 2, b = 1, stretch = "lin", main = "2017")
