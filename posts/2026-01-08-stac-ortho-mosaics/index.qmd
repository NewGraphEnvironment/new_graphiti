...
```{r fig-animation, fig.cap="Animated time series of Sentinel-2 composites from 2016-2025."}
...
1. Query Sentinel-2 imagery from Microsoft's Planetary Computer using STAC via `rstac`
