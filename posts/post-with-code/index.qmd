...
This is a post showing where we are now keeping the company equipment details as well as the company logos. We need these
...
Here is the location of the equipment lists that we use in safety/field planning:
    ...
    `r glue::glue("https://raw.githubusercontent.com/{params$repo_owner}/{params$repo_name}/main/assets/equipment.csv")`
